    ...
    <ChartCard title="Transaction Activity">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
            ...
            <XAxis dataKey="month" tick={{ fontSize: "var(--font-size-chart-axis)", fill: "var(--color-text-primary)" }} padding={{ left: 15, right: 30 }} axisLine={false} tickLine={false} />
            <YAxis tick={{ fontSize: "var(--font-size-chart-axis)", fill: "var(--color-text-primary)" }} axisLine={false} tickLine={false} width={40} />
